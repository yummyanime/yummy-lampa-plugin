...
Отключённые источники не показываются. Alloha и CVH по умолчанию выключены: для стабильного воспроизведения могут потребоваться дополнительные внешние компоненты. При включении любого из них расширение показывает предупреждение. Последнее успешно загруженное расписание доступно и при временном сбое API.
