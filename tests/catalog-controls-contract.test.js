...
assert.match(uiSource, /function Catalog\(object\)[\s\S]{0,8000}LampaYaniCatalogControls\.create/);
...
assert.match(uiSource, /LampaYaniApi\.catalog\(baseParams, object\.genre_context/);
