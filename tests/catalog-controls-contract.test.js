...
assert.match(uiSource, /catalog_params: \{limit: 30, genres: genreId\}/);
assert.match(uiSource, /function catalogRequestParams\(object\)/);
assert.match(uiSource, /function sanitizeCatalogParams\(params\)/);
assert.match(uiSource, /var baseParams = catalogRequestParams\(object\)/);
assert.match(uiSource, /var comp = new Lampa\.InteractionCategory\(object\)/);
assert.ok(uiSource.indexOf('var baseParams = catalogRequestParams(object)') < uiSource.indexOf('var comp = new Lampa.InteractionCategory(object)'), 'catalog params must be copied before InteractionCategory mutates object.params');
