...
assert.match(ui, /LampaYaniHomeSections\.fetchHistoryRange\(LampaYaniApi\.watchHistory, 300, 30, control\)/);
...
assert.match(sectionsSource, /var limit = 30/);
assert.match(sectionsSource, /var continueLimit = 300/);
