...
assert.match(collections, /card\.params = \{\s*on:\s*\{\s*'hover:enter': function \(\) \{ deps\.open\(collection\); \}/);
assert.doesNotMatch(collections, /rendered\.on\('hover:enter\.yaniCollection/);
