...
assert.match(collections, /deps\.detail\(object\.collectionId, limit, 0, \{timeout: 8000, retry: false\}\)/);
...
assert.match(collections, /deps\.detail\(object\.collectionId, limit, offset, \{timeout: 8000, retry: false\}\)/);
