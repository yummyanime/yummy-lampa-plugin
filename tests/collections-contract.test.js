...
assert.match(collections, /function collectionIdFrom\(object\)/);
assert.match(collections, /deps\.detail\(collectionId, limit, 0, \{timeout: 8000, retry: false, staleFallback: true\}\)/);
assert.match(collections, /title: deps\.t\('collection_load_error'\)/);
...
assert.match(collections, /deps\.detail\(collectionId, limit, offset, \{timeout: 8000, retry: false, staleFallback: true\}\)/);
assert.match(collections, /self\.activity\.loader\(false\)/);
