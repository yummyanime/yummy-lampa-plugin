...
assert.match(card, /var standardNativeCacheStorageKey = 'yani_standard_native_matches_v3'/);
assert.match(card, /LampaYaniUiUtils\.isAnimeTmdbCard/);
assert.match(card, /Skipping non-anime TMDB near-match/);
assert.match(fs.readFileSync('src/ui-utils.js', 'utf8'), /function titlesCloselyRelated/);
assert.match(fs.readFileSync('src/ui-utils.js', 'utf8'), /function isAnimeTmdbCard/);
